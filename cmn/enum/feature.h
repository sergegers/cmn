...
template <typename Policy, c::bitfield Feature> requires bitfield_or_combo_<Feature>
...
template <c::strong_bitfield Policy> requires detail::bitfield_or_combo_<Policy>
